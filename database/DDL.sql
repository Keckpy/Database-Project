...
-- Project Step 4 Draft: RESET Stored Procedure + Normalized Schema + Sample Data
-- Team Members: Brian Keck and Jackson Happel-Walvatne
--
-- AI Use Citation
-- Date: 08/05/2026
-- Scope: ChatGPT helped wrap the group's existing DDL and sample data in a
-- stored procedure so the application can reset the database.
-- Prompt synopsis: Add a RESET stored procedure to the existing Group 42 DDL
-- without changing the schema or sample data.
-- Originality: The schema and sample data are the group's existing work. The
-- stored-procedure wrapper was reviewed and edited for this project.
...
-- Importing this file both creates the RESET procedure and initializes the
-- tables with the project's sample data.
